                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="big-ad">
                                ...
                                <p>
                                    Dream is a social network template that can be used to connect people. use this
                                    template for multipurpose social activities like job, dating, posting, bloging and
                                    much more. Now join & Make Cool Friends around the world !!!
                                </p>
                        ...
                        <div class="col-lg-4">
                            <div class="we-login-register">
                                ...
                                <form class="we-form" method="post" action="{{ route('login.action')}}">
                                    @csrf
                                    <input type="text" name='email' placeholder="Email">
                                    <input type="password" name='password' placeholder="Password">
                                    <input type="checkbox"><label>remember me</label>
                                    <button type="submit" data-ripple="">sign in</button>
                                    <a class="forgot underline" href="password/reset" title="">forgot password?</a>
                                </form>
                                ...
                                <span>don't have an account? <a class="we-account underline" href="#" title="">register
                                        now</a></span>
                            </div>
                        </div>
